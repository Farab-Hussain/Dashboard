...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'login') {
    ...
    if (empty($username) || empty($password)) {
        ...
        if ($result['success']) {
            // Redirect based on role - only operators allowed
            if ($_SESSION['role'] === 'operator') {
                ...
                $error_message = "Access denied. Only operators can login here.";
            }
        } else {
...
if (isset($_SESSION['user_id'])) {
    // Redirect to operator dashboard if already logged in as operator
